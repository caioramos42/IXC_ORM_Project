...
class ServiceOrderModel(IModelWithId, BaseModel):
    ...
    def to_dict(self) -> dict[str, str]:
        ...
        data = {
            ...
            'id_atendente': self._serialize_enum_and_str(self.id_atendente) if self.id_atendente is not None else '',
            ...
            'protocolo': self._serialize_enum_and_str(self.protocolo) if self.protocolo is not None else '',
            ...
            'origem_endereco': self._serialize_enum_and_str(self.origem_endereco) if self.origem_endereco is not None else '',
            'origem_endereco_estrutura': self._serialize_enum_and_str(self.origem_endereco_estrutura) if self.origem_endereco_estrutura is not None else '',
            ...
            'status_conexao': self._serialize_enum_and_str(self.status_conexao) if self.status_conexao is not None else '',
            'prioridade': self._serialize_enum_and_str(self.prioridade) if self.prioridade is not None else '',
            'melhor_horario_agenda': self._serialize_enum_and_str(self.melhor_horario_agenda) if self.melhor_horario_agenda is not None else '',
            'id_tecnico': str(self.id_tecnico) if self.id_tecnico is not None else '',
            'mensagem': self._serialize_enum_and_str(self.mensagem) if self.mensagem is not None else '',
            'id_receber': self._serialize_enum_and_str(self.id_receber) if self.id_receber is not None else '',
            'idx': self._serialize_enum_and_str(self.idx) if self.idx is not None else '',
            'status_pesquisa_satisfacao': self._serialize_enum_and_str(self.status_pesquisa_satisfacao) if self.status_pesquisa_satisfacao is not None else '',
            ...
            'status_assinatura': self._serialize_enum_and_str(self.status_assinatura) if self.status_assinatura is not None else '',
            'gera_comissao': self._serialize_enum_and_str(self.gera_comissao) if self.gera_comissao is not None else '',
            ...
            'preview': self._serialize_enum_and_str(self.preview) if self.preview is not None else '',
            'id_wfl_param_os': self._serialize_enum_and_str(self.id_wfl_param_os) if self.id_wfl_param_os is not None else '',
            'id_wfl_tarefa': self._serialize_enum_and_str(self.id_wfl_tarefa) if self.id_wfl_tarefa is not None else '',
            'id_su_diagnostico': str(self.id_su_diagnostico) if self.id_su_diagnostico is not None else '',
            'regiao_manutencao': self._serialize_enum_and_str(self.regiao_manutencao) if self.regiao_manutencao is not None else '',
            'origem_cadastro': self._serialize_enum_and_str(self.origem_cadastro) if self.origem_cadastro is not None else '',
            'origem_change_endereco': self._serialize_enum_and_str(self.origem_change_endereco) if self.origem_change_endereco is not None else '',
            'status_sla': self._serialize_enum_and_str(self.status_sla) if self.status_sla is not None else '',
            'ultima_atualizacao': self._serialize_enum_and_str(self.ultima_atualizacao) if self.ultima_atualizacao is not None else '',
            'ids_login_regiao_manutencao': self._serialize_enum_and_str(self.ids_login_regiao_manutencao) if self.ids_login_regiao_manutencao is not None else '',
            'origem_os_aberta': self._serialize_enum_and_str(self.origem_os_aberta) if self.origem_os_aberta is not None else '',
            ...
            'data_abertura': self._serialize_enum_and_str(self.data_abertura) if self.data_abertura is not None else '',
            'data_inicio': self._serialize_enum_and_str(self.data_inicio) if self.data_inicio is not None else '',
            'data_hora_analise': self._serialize_enum_and_str(self.data_hora_analise) if self.data_hora_analise is not None else '',
            'data_agenda': self._serialize_enum_and_str(self.data_agenda) if self.data_agenda is not None else '',
            'data_agenda_final': self._serialize_enum_and_str(self.data_agenda_final) if self.data_agenda_final is not None else '',
            'data_hora_encaminhado': self._serialize_enum_and_str(self.data_hora_encaminhado) if self.data_hora_encaminhado is not None else '',
            'data_hora_assumido': self._serialize_enum_and_str(self.data_hora_assumido) if self.data_hora_assumido is not None else '',
            'data_hora_execucao': self._serialize_enum_and_str(self.data_hora_execucao) if self.data_hora_execucao is not None else '',
            'data_final': self._serialize_enum_and_str(self.data_final) if self.data_final is not None else '',
            'data_fechamento': self._serialize_enum_and_str(self.data_fechamento) if self.data_fechamento is not None else '',
            'data_prazo_limite': self._serialize_enum_and_str(self.data_prazo_limite) if self.data_prazo_limite is not None else '',
            'data_reservada': self._serialize_enum_and_str(self.data_reservada) if self.data_reservada is not None else '',
            'data_reagendar': self._serialize_enum_and_str(self.data_reagendar) if self.data_reagendar is not None else '',
            'data_prev_final': self._serialize_enum_and_str(self.data_prev_final) if self.data_prev_final is not None else '',
            'mensagem_resposta': self._serialize_enum_and_str(self.mensagem_resposta) if self.mensagem_resposta is not None else '',
            'justificativa_sla_atrasado': self._serialize_enum_and_str(self.justificativa_sla_atrasado) if self.justificativa_sla_atrasado is not None else '',
            'valor_total': self._serialize_enum_and_str(self.valor_total) if self.valor_total is not None else '',
            'valor_outras_despesas': self._serialize_enum_and_str(self.valor_outras_despesas) if self.valor_outras_despesas is not None else '',
            'valor_unit_comissao': self._serialize_enum_and_str(self.valor_unit_comissao) if self.valor_unit_comissao is not None else '',
            'valor_total_comissao': self._serialize_enum_and_str(self.valor_total_comissao) if self.valor_total_comissao is not None else '',
        }
