...
class ContasAReceberModel(IModelWithId, BaseModel):
    ...
    def to_dict(self) -> dict:
        ...
        data = {
            ...
            'previsao': self._serialize_enum(self.previsao) if self.previsao is not None else '',
            ...
            'arquivo_remessa_baixado': self._serialize_enum(self.arquivo_remessa_baixado) if self.arquivo_remessa_baixado is not None else '',
            ...
            'forma_recebimento': self._serialize_enum(self.forma_recebimento) if self.forma_recebimento is not None else '',
            ...
            'titulo_protestado': self._serialize_enum(self.titulo_protestado) if self.titulo_protestado is not None else '',
            ...
            'titulo_renegociado': self._serialize_enum(self.titulo_renegociado) if self.titulo_renegociado is not None else '',
            ...
            'etapa_envio_regua': self._serialize_enum(self.etapa_envio_regua) if self.etapa_envio_regua is not None else '',
            'status_cobranca_regua': self._serialize_enum(self.status_cobranca_regua) if self.status_cobranca_regua is not None else '',
            'ids_contratos_origem': self.ids_contratos_origem if self.ids_contratos_origem is not None else '',
            'em_cobranca': self._serialize_enum(self.em_cobranca) if self.em_cobranca is not None else '',
            ...
            'titulo_importado': self._serialize_enum(self.titulo_importado) if self.titulo_importado is not None else '',
            'aguardando_confirmacao_pagamento': self._serialize_enum(self.aguardando_confirmacao_pagamento) if self.aguardando_confirmacao_pagamento is not None else '',
            'parcelado_cartao': self._serialize_enum(self.parcelado_cartao) if self.parcelado_cartao is not None else '',
            'bandeira_pagamento': self.bandeira_pagamento if self.bandeira_pagamento is not None else '',
            'recebido_via_pix': self._serialize_enum(self.recebido_via_pix) if self.recebido_via_pix is not None else '',
            'recebido_por_recorrencia': self._serialize_enum(self.recebido_por_recorrencia) if self.recebido_por_recorrencia is not None else '',
            'estornado': self._serialize_enum(self.estornado) if self.estornado is not None else '',
            ...
            'motivo_alteracao': self._serialize_enum(self.motivo_alteracao) if self.motivo_alteracao is not None else '',
            'pix_txid': self.pix_txid if self.pix_txid is not None else '',
            'tipo_cobranca_pix': self._serialize_enum(self.tipo_cobranca_pix) if self.tipo_cobranca_pix is not None else '',
            'pix_txid_recorrente': self.pix_txid_recorrente if self.pix_txid_recorrente is not None else '',
            'pix_status_recorrente': self._serialize_enum(self.pix_status_recorrente) if self.pix_status_recorrente is not None else '',
            ...
            'libera_periodo': self._serialize_enum(self.libera_periodo) if self.libera_periodo is not None else '',
