...
class ContratoDoClienteModel(IModelWithId, BaseModel):
    ...
    def to_dict(self) -> dict[str, str]:
        ...
        data = {
            ...
            'contrato': self._serialize_enum_and_str(self.contrato) if self.contrato is not None else '',
            ...
            'endereco_padrao_cliente': self._serialize_enum_and_str(self.endereco_padrao_cliente) if self.endereco_padrao_cliente is not None else '',
            'tipo': self._serialize_enum_and_str(self.tipo) if self.tipo is not None else '',
            'estrato_social_col': self._serialize_enum_and_str(self.estrato_social_col) if self.estrato_social_col is not None else '',
            'descricao_aux_plano_venda': self._serialize_enum_and_str(self.descricao_aux_plano_venda) if self.descricao_aux_plano_venda is not None else '',
            'assinatura_digital': self._serialize_enum_and_str(self.assinatura_digital) if self.assinatura_digital is not None else '',
            ...
            'liberacao_bloqueio_manual': self._serialize_enum_and_str(self.liberacao_bloqueio_manual) if self.liberacao_bloqueio_manual is not None else '',
            'indicacao_contrato_id': str(self.indicacao_contrato_id) if self.indicacao_contrato_id is not None else '',
            'data_assinatura': self._serialize_enum_and_str(self.data_assinatura) if self.data_assinatura is not None else '',
            'isentar_contrato': self._serialize_enum_and_str(self.isentar_contrato) if self.isentar_contrato is not None else '',
            'data_ativacao': self._serialize_enum_and_str(self.data_ativacao) if self.data_ativacao is not None else '',
            'situacao_financeira_contrato': self._serialize_enum_and_str(self.situacao_financeira_contrato) if self.situacao_financeira_contrato is not None else '',
            'data_renovacao': self._serialize_enum_and_str(self.data_renovacao) if self.data_renovacao is not None else '',
            'pago_ate_data': self._serialize_enum_and_str(self.pago_ate_data) if self.pago_ate_data is not None else '',
            'status': self._serialize_enum_and_str(self.status) if self.status is not None else '',
            'status_internet': self._serialize_enum_and_str(self.status_internet) if self.status_internet is not None else '',
            'status_velocidade': self._serialize_enum_and_str(self.status_velocidade) if self.status_velocidade is not None else '',
            'tipo_produtos_plano': self._serialize_enum_and_str(self.tipo_produtos_plano) if self.tipo_produtos_plano is not None else '',
            'motivo_inclusao': self._serialize_enum_and_str(self.motivo_inclusao) if self.motivo_inclusao is not None else '',
            ...
            'url_assinatura_digital': self._serialize_enum_and_str(self.url_assinatura_digital) if self.url_assinatura_digital is not None else '',
            'token_assinatura_digital': self._serialize_enum_and_str(self.token_assinatura_digital) if self.token_assinatura_digital is not None else '',
            ...
            'cc_previsao': self._serialize_enum_and_str(self.cc_previsao) if self.cc_previsao is not None else '',
            ...
            'renovacao_automatica': self._serialize_enum_and_str(self.renovacao_automatica) if self.renovacao_automatica is not None else '',
            'gerar_finan_assin_digital_contrato': self._serialize_enum_and_str(self.gerar_finan_assin_digital_contrato) if self.gerar_finan_assin_digital_contrato is not None else '',
            'agrupar_financeiro_contrato': self._serialize_enum_and_str(self.agrupar_financeiro_contrato) if self.agrupar_financeiro_contrato is not None else '',
            'aplicar_desconto_tempo_bloqueio': self._serialize_enum_and_str(self.aplicar_desconto_tempo_bloqueio) if self.aplicar_desconto_tempo_bloqueio is not None else '',
            'num_parcelas_atraso': self._serialize_enum_and_str(self.num_parcelas_atraso) if self.num_parcelas_atraso is not None else '',
            'contrato_recorrencia': self._serialize_enum_and_str(self.contrato_recorrencia) if self.contrato_recorrencia is not None else '',
            'credit_card_recorrente_bandeira_cartao': self._serialize_enum_and_str(self.credit_card_recorrente_bandeira_cartao) if self.credit_card_recorrente_bandeira_cartao is not None else '',
            'credit_card_recorrente_token': self._serialize_enum_and_str(self.credit_card_recorrente_token) if self.credit_card_recorrente_token is not None else '',
            'ids_contratos_recorrencia': self._serialize_enum_and_str(self.ids_contratos_recorrencia) if self.ids_contratos_recorrencia is not None else '',
            'status_recorrencia': self._serialize_enum_and_str(self.status_recorrencia) if self.status_recorrencia is not None else '',
            'base_geracao_tipo_doc': self._serialize_enum_and_str(self.base_geracao_tipo_doc) if self.base_geracao_tipo_doc is not None else '',
            ...
            'nf_info_adicionais': self._serialize_enum_and_str(self.nf_info_adicionais) if self.nf_info_adicionais is not None else '',
            ...
            'taxa_instalacao': self._serialize_enum_and_str(self.taxa_instalacao) if self.taxa_instalacao is not None else '',
            ...
            'ativacao_numero_parcelas': self._serialize_enum_and_str(self.ativacao_numero_parcelas) if self.ativacao_numero_parcelas is not None else '',
            'ativacao_vencimentos': self._serialize_enum_and_str(self.ativacao_vencimentos) if self.ativacao_vencimentos is not None else '',
            'btn_nf_ativacao': self._serialize_enum_and_str(self.btn_nf_ativacao) if self.btn_nf_ativacao is not None else '',
            'ativacao_valor_parcela': self._serialize_enum_and_str(self.ativacao_valor_parcela) if self.ativacao_valor_parcela is not None else '',
            'fidelidade': self._serialize_enum_and_str(self.fidelidade) if self.fidelidade is not None else '',
            'data_expiracao': self._serialize_enum_and_str(self.data_expiracao) if self.data_expiracao is not None else '',
            'dica_data_expiracao': self._serialize_enum_and_str(self.dica_data_expiracao) if self.dica_data_expiracao is not None else '',
            'desconto_fidelidade': self._serialize_enum_and_str(self.desconto_fidelidade) if self.desconto_fidelidade is not None else '',
            'id_instalador': str(self.id_instalador) if self.id_instalador is not None else '',
            'taxa_improdutiva': self._serialize_enum_and_str(self.taxa_improdutiva) if self.taxa_improdutiva is not None else '',
            'venc_personalizado': self._serialize_enum_and_str(self.venc_personalizado) if self.venc_personalizado is not None else '',
            'com_entrada': self._serialize_enum_and_str(self.com_entrada) if self.com_entrada is not None else '',
            'dia_fixo_vencimento': self._serialize_enum_and_str(self.dia_fixo_vencimento) if self.dia_fixo_vencimento is not None else '',
            'tipo_condicao_pag': self._serialize_enum_and_str(self.tipo_condicao_pag) if self.tipo_condicao_pag is not None else '',
            'bloqueio_automatico': self._serialize_enum_and_str(self.bloqueio_automatico) if self.bloqueio_automatico is not None else '',
            'nao_bloquear_ate': self._serialize_enum_and_str(self.nao_bloquear_ate) if self.nao_bloquear_ate is not None else '',
            'aviso_atraso': self._serialize_enum_and_str(self.aviso_atraso) if self.aviso_atraso is not None else '',
            'nao_avisar_ate': self._serialize_enum_and_str(self.nao_avisar_ate) if self.nao_avisar_ate is not None else '',
            'desbloqueio_confianca': self._serialize_enum_and_str(self.desbloqueio_confianca) if self.desbloqueio_confianca is not None else '',
            'desbloqueio_confianca_ativo': self._serialize_enum_and_str(self.desbloqueio_confianca_ativo) if self.desbloqueio_confianca_ativo is not None else '',
            'restricao_auto_desbloqueio': self._serialize_enum_and_str(self.restricao_auto_desbloqueio) if self.restricao_auto_desbloqueio is not None else '',
            'motivo_restricao_auto_desbloq': self._serialize_enum_and_str(self.motivo_restricao_auto_desbloq) if self.motivo_restricao_auto_desbloq is not None else '',
            'obs': self._serialize_enum_and_str(self.obs) if self.obs is not None else '',
            'nao_susp_parc_ate': self._serialize_enum_and_str(self.nao_susp_parc_ate) if self.nao_susp_parc_ate is not None else '',
            'liberacao_suspensao_parcial': self._serialize_enum_and_str(self.liberacao_suspensao_parcial) if self.liberacao_suspensao_parcial is not None else '',
            'utilizando_auto_libera_susp_parc': self._serialize_enum_and_str(self.utilizando_auto_libera_susp_parc) if self.utilizando_auto_libera_susp_parc is not None else '',
            'restricao_auto_libera_susp_parcial': self._serialize_enum_and_str(self.restricao_auto_libera_susp_parcial) if self.restricao_auto_libera_susp_parcial is not None else '',
            'motivo_restri_auto_libera_parc': self._serialize_enum_and_str(self.motivo_restri_auto_libera_parc) if self.motivo_restri_auto_libera_parc is not None else '',
            'contrato_suspenso': self._serialize_enum_and_str(self.contrato_suspenso) if self.contrato_suspenso is not None else '',
            'data_inicial_suspensao': self._serialize_enum_and_str(self.data_inicial_suspensao) if self.data_inicial_suspensao is not None else '',
            'data_final_suspensao': self._serialize_enum_and_str(self.data_final_suspensao) if self.data_final_suspensao is not None else '',
            'data_acesso_desativado': self._serialize_enum_and_str(self.data_acesso_desativado) if self.data_acesso_desativado is not None else '',
            'fieldset_mensagem_atencao_irreversivel': self._serialize_enum_and_str(self.fieldset_mensagem_atencao_irreversivel) if self.fieldset_mensagem_atencao_irreversivel is not None else '',
            'data_cancelamento': self._serialize_enum_and_str(self.data_cancelamento) if self.data_cancelamento is not None else '',
            ...
            'obs_cancelamento': self._serialize_enum_and_str(self.obs_cancelamento) if self.obs_cancelamento is not None else '',
            'tempo_permanencia': self._serialize_enum_and_str(self.tempo_permanencia) if self.tempo_permanencia is not None else '',
            'dica_tmp': self._serialize_enum_and_str(self.dica_tmp) if self.dica_tmp is not None else '',
            'origem_cancelamento': self._serialize_enum_and_str(self.origem_cancelamento) if self.origem_cancelamento is not None else '',
            'data_negativacao': self._serialize_enum_and_str(self.data_negativacao) if self.data_negativacao is not None else '',
            'id_responsavel_negativacao': str(self.id_responsavel_negativacao) if self.id_responsavel_negativacao is not None else '',
            'protocolo_negativacao': self._serialize_enum_and_str(self.protocolo_negativacao) if self.protocolo_negativacao is not None else '',
            'id_motivo_negativacao': str(self.id_motivo_negativacao) if self.id_motivo_negativacao is not None else '',
            'obs_negativacao': self._serialize_enum_and_str(self.obs_negativacao) if self.obs_negativacao is not None else '',
            'data_desistencia': self._serialize_enum_and_str(self.data_desistencia) if self.data_desistencia is not None else '',
            ...
            'obs_desistencia': self._serialize_enum_and_str(self.obs_desistencia) if self.obs_desistencia is not None else '',
            'obs_contrato': self._serialize_enum_and_str(self.obs_contrato) if self.obs_contrato is not None else '',
            'alerta_contrato': self._serialize_enum_and_str(self.alerta_contrato) if self.alerta_contrato is not None else '',
            'imp_realizado': self._serialize_enum_and_str(self.imp_realizado) if self.imp_realizado is not None else '',
            'imp_inicial': self._serialize_enum_and_str(self.imp_inicial) if self.imp_inicial is not None else '',
            'imp_carteira': self._serialize_enum_and_str(self.imp_carteira) if self.imp_carteira is not None else '',
            'imp_importacao': self._serialize_enum_and_str(self.imp_importacao) if self.imp_importacao is not None else '',
            'imp_treinamento': self._serialize_enum_and_str(self.imp_treinamento) if self.imp_treinamento is not None else '',
            'imp_rede': self._serialize_enum_and_str(self.imp_rede) if self.imp_rede is not None else '',
            'imp_bkp': self._serialize_enum_and_str(self.imp_bkp) if self.imp_bkp is not None else '',
            'imp_obs': self._serialize_enum_and_str(self.imp_obs) if self.imp_obs is not None else '',
            'imp_final': self._serialize_enum_and_str(self.imp_final)    if self.imp_final is not None else '',
            'imp_status': self._serialize_enum_and_str(self.imp_status) if self.imp_status is not None else '',
            'imp_motivo': self._serialize_enum_and_str(self.imp_motivo) if self.imp_motivo is not None else '',
            'dt_ult_bloq_auto': self._serialize_enum_and_str(self.dt_ult_bloq_auto) if self.dt_ult_bloq_auto is not None else '',
            'dt_ult_bloq_manual': self._serialize_enum_and_str(self.dt_ult_bloq_manual) if self.dt_ult_bloq_manual is not None else '',
            'dt_ult_desbloq_auto': self._serialize_enum_and_str(self.dt_ult_desbloq_auto) if self.dt_ult_desbloq_auto is not None else '',
            'dt_ult_desbloq_manual': self._serialize_enum_and_str(self.dt_ult_desbloq_manual) if self.dt_ult_desbloq_manual is not None else '',
            'dt_ult_finan_atraso': self._serialize_enum_and_str(self.dt_ult_finan_atraso) if self.dt_ult_finan_atraso is not None else '',
            'dt_ult_des_bloq_conf': self._serialize_enum_and_str(self.dt_ult_des_bloq_conf) if self.dt_ult_des_bloq_conf is not None else '',
            'dt_ult_liberacao_susp_parc': self._serialize_enum_and_str(self.dt_ult_liberacao_susp_parc) if self.dt_ult_liberacao_susp_parc is not None else '',
            'dt_ult_ativacao': self._serialize_enum_and_str(self.dt_ult_ativacao) if self.dt_ult_ativacao is not None else '',
            'dt_utl_negativacao': self._serialize_enum_and_str(self.dt_utl_negativacao) if self.dt_utl_negativacao is not None else '',
            'dt_ult_desiste': self._serialize_enum_and_str(self.dt_ult_desiste) if self.dt_ult_desiste is not None else '',
            'data_cadastro_sistema': self._serialize_enum_and_str(self.data_cadastro_sistema) if self.data_cadastro_sistema is not None else '',
            'ultima_atualizacao': self._serialize_enum_and_str(self.ultima_atualizacao) if self.ultima_atualizacao is not None else '',
            'data_retomada_contrato': self._serialize_enum_and_str(self.data_retomada_contrato) if self.data_retomada_contrato is not None else '',
            ...
            'bloco': self._serialize_enum_and_str(self.bloco) if self.bloco is not None else '',
            'bloco_novo': self._serialize_enum_and_str(self.bloco_novo) if self.bloco_novo is not None else '',
            'apartamento': self._serialize_enum_and_str(self.apartamento) if self.apartamento is not None else '',
            'apartamento_novo': self._serialize_enum_and_str(self.apartamento_novo) if self.apartamento_novo is not None else '',
            'cep': self._serialize_enum_and_str(self.cep) if self.cep is not None else '',
            'cep_novo': self._serialize_enum_and_str(self.cep_novo) if self.cep_novo is not None else '',
            'endereco': self._serialize_enum_and_str(self.endereco) if self.endereco is not None else '',
            'endereco_novo': self._serialize_enum_and_str(self.endereco_novo) if self.endereco_novo is not None else '',
            'numero': self._serialize_enum_and_str(self.numero) if self.numero is not None else '',
            'numero_novo': self._serialize_enum_and_str(self.numero_novo) if self.numero_novo is not None else '',
            'bairro': self._serialize_enum_and_str(self.bairro) if self.bairro is not None else '',
            'bairro_novo': self._serialize_enum_and_str(self.bairro_novo) if self.bairro_novo is not None else '',
            ...
            'complemento_novo': self._serialize_enum_and_str(self.complemento_novo) if self.complemento_novo is not None else '',
            'referencia': self._serialize_enum_and_str(self.referencia) if self.referencia is not None else '',
            'referencia_novo': self._serialize_enum_and_str(self.referencia_novo) if self.referencia_novo is not None else '',
            'latitude': self._serialize_enum_and_str(self.latitude) if self.latitude is not None else '',
            'latitude_novo': self._serialize_enum_and_str(self.latitude_novo) if self.latitude_novo is not None else '',
            'longitude': self._serialize_enum_and_str(self.longitude) if self.longitude is not None else '',
            'longitude_novo': self._serialize_enum_and_str(self.longitude_novo) if self.longitude_novo is not None else '',
            'tipo_localidade': self._serialize_enum_and_str(self.tipo_localidade) if self.tipo_localidade is not None else '',
            ...
            'email_assinatura_digital': self._serialize_enum_and_str(self.email_assinatura_digital) if self.email_assinatura_digital is not None else '',
            'contato_assinatura_digital': self._serialize_enum_and_str(self.contato_assinatura_digital) if self.contato_assinatura_digital is not None else '',
            'document_photo': self._serialize_enum_and_str(self.document_photo) if self.document_photo is not None else '',
            'selfie_photo': self._serialize_enum_and_str(self.selfie_photo) if self.selfie_photo is not None else '',
        }
