...
class ClientModel(IModelWithId, BaseModel):
    ...
    def to_dict(self) -> dict:
        ...
        data =  {
            'id': str(self.id),
            'razao': self._serialize_enum_and_str(self.razao) if self.razao is not None else '',
            ...
            'dica_imposto_retido_cliente': self._serialize_enum_and_str(self.dica_imposto_retido_cliente) if self.dica_imposto_retido_cliente is not None else '',
            'ativo': self._serialize_enum_and_str(self.ativo),
            'id_tipo_cliente': str(self.id_tipo_cliente) if self.id_tipo_cliente is not None else '',
            'tipo_cliente_scm': self._serialize_enum_and_str(self.tipo_cliente_scm),
            'tipo_ente_governamental': self._serialize_enum_and_str(self.tipo_ente_governamental),
            'pais': self._serialize_enum_and_str(self.pais) if self.pais is not None else '',
            'tipo_pessoa': self._serialize_enum_and_str(self.tipo_pessoa),
            'regime_fiscal_col': self._serialize_enum_and_str(self.regime_fiscal_col),
            'nome_social': self._serialize_enum_and_str(self.nome_social) if self.nome_social is not None else '',
            'fantasia': self._serialize_enum_and_str(self.fantasia) if self.fantasia is not None else '',
            'tipo_documento_identificacao': self._serialize_enum_and_str(self.tipo_documento_identificacao),
            ...
            'contribuinte_icms': self._serialize_enum_and_str(self.contribuinte_icms),
            'contribuinte_icms_alert': self._serialize_enum_and_str(self.contribuinte_icms_alert) if self.contribuinte_icms_alert is not None else '',
            ...
            'Sexo': self._serialize_enum_and_str(self.Sexo),
            'profissao': self._serialize_enum_and_str(self.profissao) if self.profissao is not None else '',
            'estado_civil': self._serialize_enum_and_str(self.estado_civil),
            'inscricao_municipal': self._serialize_enum_and_str(self.inscricao_municipal) if self.inscricao_municipal is not None else '',
            'isuf': self._serialize_enum_and_str(self.isuf) if self.isuf is not None else '',
            'tipo_assinante': self._serialize_enum_and_str(self.tipo_assinante),
            'filial_id': str(self.filial_id) if self.filial_id is not None else '',
            'filtra_filial': self._serialize_enum_and_str(self.filtra_filial),
            'idx': self._serialize_enum_and_str(self.idx) if self.idx is not None else '',
            'data_cadastro': self._serialize_enum_and_str(self.data_cadastro) if self.data_cadastro is not None else '',
            'ativo_serasa': self._serialize_enum_and_str(self.ativo_serasa),
            'convert_cliente_forn': self._serialize_enum_and_str(self.convert_cliente_forn),
            'atualizar_cadastro_galaxPay': self._serialize_enum_and_str(self.atualizar_cadastro_galaxPay) if self.atualizar_cadastro_galaxPay is not None else '',
            'grau_satisfacao': self._serialize_enum_and_str(self.grau_satisfacao),
            ...
            'cif': self._serialize_enum_and_str(self.cif) if self.cif is not None else '',
            ...
            'moradia': self._serialize_enum_and_str(self.moradia),
            'tipo_localidade': self._serialize_enum_and_str(self.tipo_localidade),
            ...
            'cep_cob': self._serialize_enum_and_str(self.cep_cob) if self.cep_cob is not None else '',
            'endereco_cob': self._serialize_enum_and_str(self.endereco_cob) if self.endereco_cob is not None else '',
            'numero_cob': self._serialize_enum_and_str(self.numero_cob) if self.numero_cob is not None else '',
            'bairro_cob': self._serialize_enum_and_str(self.bairro_cob) if self.bairro_cob is not None else '',
            'cidade_cob': str(self.cidade_cob) if self.cidade_cob is not None else '',
            'complemento_cob': self._serialize_enum_and_str(self.complemento_cob) if self.complemento_cob is not None else '',
            'referencia_cob': self._serialize_enum_and_str(self.referencia_cob) if self.referencia_cob is not None else '',
            'uf_cob': self._serialize_enum_and_str(self.uf_cob) if self.uf_cob is not None else '',
            ...
            'ramal': self._serialize_enum_and_str(self.ramal) if self.ramal is not None else '',
            'id_operadora_celular': str(self.id_operadora_celular) if self.id_operadora_celular is not None else '',
            'telefone_celular': self._serialize_enum_and_str(self.telefone_celular) if self.telefone_celular is not None else '',
            'whatsapp': self._serialize_enum_and_str(self.whatsapp) if self.whatsapp is not None else '',
            'email': self._serialize_enum_and_str(self.email) if self.email is not None else '',
            'contato': self._serialize_enum_and_str(self.contato) if self.contato is not None else '',
            'website': self._serialize_enum_and_str(self.website) if self.website is not None else '',
            'skype': self._serialize_enum_and_str(self.skype) if self.skype is not None else '',
            'facebook': self._serialize_enum_and_str(self.facebook) if self.facebook is not None else '',
            'hotsite_email': self._serialize_enum_and_str(self.hotsite_email) if self.hotsite_email is not None else '',
            'senha': self._serialize_enum_and_str(self.senha) if self.senha is not None else '',
            'acesso_automatico_central': self._serialize_enum_and_str(self.acesso_automatico_central),
            'alterar_senha_primeiro_acesso': self._serialize_enum_and_str(self.alterar_senha_primeiro_acesso),
            'senha_hotsite_md5': self._serialize_enum_and_str(self.senha_hotsite_md5),
            'hotsite_acesso': self._serialize_enum_and_str(self.hotsite_acesso) if self.hotsite_acesso is not None else '',
            'crm': self._serialize_enum_and_str(self.crm),
            ...
            'cadastrado_via_viabilidade': self._serialize_enum_and_str(self.cadastrado_via_viabilidade),
            'status_prospeccao': self._serialize_enum_and_str(self.status_prospeccao),
            'crm_data_novo': self._serialize_enum_and_str(self.crm_data_novo) if self.crm_data_novo is not None else '',
            'crm_data_sondagem': self._serialize_enum_and_str(self.crm_data_sondagem) if self.crm_data_sondagem is not None else '',
            'crm_data_apresentando': self._serialize_enum_and_str(self.crm_data_apresentando) if self.crm_data_apresentando is not None else '',
            'crm_data_negociando': self._serialize_enum_and_str(self.crm_data_negociando) if self.crm_data_negociando is not None else '',
            'crm_data_vencemos': self._serialize_enum_and_str(self.crm_data_vencemos) if self.crm_data_vencemos is not None else '',
            'crm_data_perdemos': self._serialize_enum_and_str(self.crm_data_perdemos) if self.crm_data_perdemos is not None else '',
            'crm_data_abortamos': self._serialize_enum_and_str(self.crm_data_abortamos) if self.crm_data_abortamos is not None else '',
            'crm_data_sem_porta_disponivel': self._serialize_enum_and_str(self.crm_data_sem_porta_disponivel) if self.crm_data_sem_porta_disponivel is not None else '',
            'crm_data_sem_viabilidade': self._serialize_enum_and_str(self.crm_data_sem_viabilidade) if self.crm_data_sem_viabilidade is not None else '',
            'pipe_id_organizacao': self._serialize_enum_and_str(self.pipe_id_organizacao) if self.pipe_id_organizacao is not None else '',
            'foto_cartao': self._serialize_enum_and_str(self.foto_cartao) if self.foto_cartao is not None else '',
            'participa_cobranca': self._serialize_enum_and_str(self.participa_cobranca) if self.participa_cobranca is not None else '',
            'num_dias_cob': self._serialize_enum_and_str(self.num_dias_cob) if self.num_dias_cob is not None else '',
            'participa_pre_cobranca': self._serialize_enum_and_str(self.participa_pre_cobranca),
            'cob_envia_email': self._serialize_enum_and_str(self.cob_envia_email),
            'cob_envia_sms': self._serialize_enum_and_str(self.cob_envia_sms),
            'fieldset_mensagem_atencao_regua_crm': self._serialize_enum_and_str(self.fieldset_mensagem_atencao_regua_crm) if self.fieldset_mensagem_atencao_regua_crm is not None else '',
            ...
            'deb_automatico': self._serialize_enum_and_str(self.deb_automatico) if self.deb_automatico is not None else '',
            'deb_agencia': self._serialize_enum_and_str(self.deb_agencia) if self.deb_agencia is not None else '',
            'deb_conta': self._serialize_enum_and_str(self.deb_conta) if self.deb_conta is not None else '',
            'codigo_operacao': self._serialize_enum_and_str(self.codigo_operacao) if self.codigo_operacao is not None else '',
            'tipo_pessoa_titular_conta': self._serialize_enum_and_str(self.tipo_pessoa_titular_conta),
            'cnpj_cpf_titular_conta': self._serialize_enum_and_str(self.cnpj_cpf_titular_conta) if self.cnpj_cpf_titular_conta is not None else '',
            'ultima_atualizacao': self._serialize_enum_and_str(self.ultima_atualizacao) if self.ultima_atualizacao is not None else '',
            'regua_cobranca_considera': self._serialize_enum_and_str(self.regua_cobranca_considera),
            'regua_cobranca_wpp': self._serialize_enum_and_str(self.regua_cobranca_wpp),
            'regua_cobranca_notificacao': self._serialize_enum_and_str(self.regua_cobranca_notificacao),
            'fieldset_mensagem_atencao_regua': self._serialize_enum_and_str(self.fieldset_mensagem_atencao_regua) if self.fieldset_mensagem_atencao_regua is not None else '',
            'nome_pai': self._serialize_enum_and_str(self.nome_pai) if self.nome_pai is not None else '',
            'cpf_pai': self._serialize_enum_and_str(self.cpf_pai) if self.cpf_pai is not None else '',
            'identidade_pai': self._serialize_enum_and_str(self.identidade_pai) if self.identidade_pai is not None else '',
            'nascimento_pai': self._serialize_enum_and_str(self.nascimento_pai) if self.nascimento_pai is not None else '',
            'nome_mae': self._serialize_enum_and_str(self.nome_mae) if self.nome_mae is not None else '',
            'cpf_mae': self._serialize_enum_and_str(self.cpf_mae) if self.cpf_mae is not None else '',
            'identidade_mae': self._serialize_enum_and_str(self.identidade_mae) if self.identidade_mae is not None else '',
            'nascimento_mae': self._serialize_enum_and_str(self.nascimento_mae) if self.nascimento_mae is not None else '',
            'quantidade_dependentes': self._serialize_enum_and_str(self.quantidade_dependentes) if self.quantidade_dependentes is not None else '',
            'nome_conjuge': self._serialize_enum_and_str(self.nome_conjuge) if self.nome_conjuge is not None else '',
            'fone_conjuge': self._serialize_enum_and_str(self.fone_conjuge) if self.fone_conjuge is not None else '',
            ...
            'data_nascimento_conjuge': self._serialize_enum_and_str(self.data_nascimento_conjuge) if self.data_nascimento_conjuge is not None else '',
            'nome_contador': self._serialize_enum_and_str(self.nome_contador) if self.nome_contador is not None else '',
            'telefone_contador': self._serialize_enum_and_str(self.telefone_contador) if self.telefone_contador is not None else '',
            'orgao_publico': self._serialize_enum_and_str(self.orgao_publico),
            'im': self._serialize_enum_and_str(self.im) if self.im is not None else '',
            'nome_representante_1': self._serialize_enum_and_str(self.nome_representante_1) if self.nome_representante_1 is not None else '',
            'cpf_representante_1': self._serialize_enum_and_str(self.cpf_representante_1) if self.cpf_representante_1 is not None else '',
            'identidade_representante_1': self._serialize_enum_and_str(self.identidade_representante_1) if self.identidade_representante_1 is not None else '',
            'nome_representante_2': self._serialize_enum_and_str(self.nome_representante_2) if self.nome_representante_2 is not None else '',
            'cpf_representante_2': self._serialize_enum_and_str(self.cpf_representante_2) if self.cpf_representante_2 is not None else '',
            'identidade_representante_2': self._serialize_enum_and_str(self.identidade_representante_2) if self.identidade_representante_2 is not None else '',
            'emp_empresa': self._serialize_enum_and_str(self.emp_empresa) if self.emp_empresa is not None else '',
            'emp_cnpj': self._serialize_enum_and_str(self.emp_cnpj) if self.emp_cnpj is not None else '',
            'emp_cep': self._serialize_enum_and_str(self.emp_cep) if self.emp_cep is not None else '',
            'emp_endereco': self._serialize_enum_and_str(self.emp_endereco) if self.emp_endereco is not None else '',
            'emp_cidade': self._serialize_enum_and_str(self.emp_cidade) if self.emp_cidade is not None else '',
            'emp_fone': self._serialize_enum_and_str(self.emp_fone) if self.emp_fone is not None else '',
            'emp_cargo': self._serialize_enum_and_str(self.emp_cargo) if self.emp_cargo is not None else '',
            'emp_remuneracao': self._serialize_enum_and_str(self.emp_remuneracao) if self.emp_remuneracao is not None else '',
            'emp_data_admissao': self._serialize_enum_and_str(self.emp_data_admissao) if self.emp_data_admissao is not None else '',
            'iss_classificacao_padrao': self._serialize_enum_and_str(self.iss_classificacao_padrao),
            'pis_retem': self._serialize_enum_and_str(self.pis_retem) if self.pis_retem is not None else '',
            'cofins_retem': self._serialize_enum_and_str(self.cofins_retem) if self.cofins_retem is not None else '',
            'csll_retem': self._serialize_enum_and_str(self.csll_retem) if self.csll_retem is not None else '',
            'irrf_retem': self._serialize_enum_and_str(self.irrf_retem) if self.irrf_retem is not None else '',
            'desconto_irrf_valor_inferior': self._serialize_enum_and_str(self.desconto_irrf_valor_inferior),
            'inss_retem': self._serialize_enum_and_str(self.inss_retem) if self.inss_retem is not None else '',
            'cli_desconta_iss_retido_total': self._serialize_enum_and_str(self.cli_desconta_iss_retido_total) if self.cli_desconta_iss_retido_total is not None else '',
            'percentual_reducao': self._serialize_enum_and_str(self.percentual_reducao) if self.percentual_reducao is not None else '',
            'ref_com_empresa1': self._serialize_enum_and_str(self.ref_com_empresa1) if self.ref_com_empresa1 is not None else '',
            'ref_com_fone1': self._serialize_enum_and_str(self.ref_com_fone1) if self.ref_com_fone1 is not None else '',
            'ref_com_empresa2': self._serialize_enum_and_str(self.ref_com_empresa2) if self.ref_com_empresa2 is not None else '',
            'ref_com_fone2': self._serialize_enum_and_str(self.ref_com_fone2) if self.ref_com_fone2 is not None else '',
            'ref_pes_nome1': self._serialize_enum_and_str(self.ref_pes_nome1) if self.ref_pes_nome1 is not None else '',
            'ref_pes_fone1': self._serialize_enum_and_str(self.ref_pes_fone1) if self.ref_pes_fone1 is not None else '',
            'ref_pes_nome2': self._serialize_enum_and_str(self.ref_pes_nome2) if self.ref_pes_nome2 is not None else '',
            'ref_pes_fone2': self._serialize_enum_and_str(self.ref_pes_fone2) if self.ref_pes_fone2 is not None else '',
            'obs': self._serialize_enum_and_str(self.obs) if self.obs is not None else '',
            'alerta': self._serialize_enum_and_str(self.alerta) if self.alerta is not None else '',
        }
