...
class AtendimentoModel(IModelWithId, BaseModel):
    ...
    def to_dict(self) -> dict:
        return {
            'id': str(self.id),
            'titulo': self._serialize_enum_and_str(self.titulo) if self.titulo is not None else '',
            'id_ticket_setor': str(self.id_ticket_setor) if self.id_ticket_setor is not None else '',
            'menssagem': self._serialize_enum_and_str(self.menssagem) if self.menssagem is not None else '',
            ...
            'data_criacao': self._serialize_enum_and_str(self.data_criacao) if self.data_criacao is not None else '',
            'data_ultima_alteracao': self._serialize_enum_and_str(self.data_ultima_alteracao) if self.data_ultima_alteracao is not None else '',
            ...
            'melhor_horario_reserva': self._serialize_enum_and_str(self.melhor_horario_reserva) if self.melhor_horario_reserva is not None else '',
            'id_ticket_origem': self._serialize_enum_and_str(self.id_ticket_origem) if self.id_ticket_origem is not None else '',
            ...
            'interacao_pendente': self._serialize_enum_and_str(self.interacao_pendente) if self.interacao_pendente is not None else '',
            'su_status': self._serialize_enum_and_str(self.su_status) if self.su_status is not None else '',
            ...
            'mensagens_nao_lida_cli': self._serialize_enum_and_str(self.mensagens_nao_lida_cli) if self.mensagens_nao_lida_cli is not None else '',
            'mensagens_nao_lida_sup': self._serialize_enum_and_str(self.mensagens_nao_lida_sup) if self.mensagens_nao_lida_sup is not None else '',
            'token': self._serialize_enum_and_str(self.token) if self.token is not None else '',
            'finalizar_atendimento': self._serialize_enum_and_str(self.finalizar_atendimento) if self.finalizar_atendimento is not None else '',
            ...
            'updated_user': self._serialize_enum_and_str(self.updated_user) if self.updated_user is not None else '',
            'ultima_atualizacao': self._serialize_enum_and_str(self.ultima_atualizacao) if self.ultima_atualizacao is not None else '',
            'cliente_fone': self._serialize_enum_and_str(self.cliente_fone) if self.cliente_fone is not None else '',
            'cliente_telefone_comercial': self._serialize_enum_and_str(self.cliente_telefone_comercial) if self.cliente_telefone_comercial is not None else '',
            'cliente_id_operadora_celular': self._serialize_enum_and_str(self.cliente_id_operadora_celular) if self.cliente_id_operadora_celular is not None else '',
            'cliente_telefone_celular': self._serialize_enum_and_str(self.cliente_telefone_celular) if self.cliente_telefone_celular is not None else '',
            'cliente_whatsapp': self._serialize_enum_and_str(self.cliente_whatsapp) if self.cliente_whatsapp is not None else '',
            'cliente_ramal': self._serialize_enum_and_str(self.cliente_ramal) if self.cliente_ramal is not None else '',
            'cliente_email': self._serialize_enum_and_str(self.cliente_email) if self.cliente_email is not None else '',
            'cliente_contato': self._serialize_enum_and_str(self.cliente_contato) if self.cliente_contato is not None else '',
            'cliente_website': self._serialize_enum_and_str(self.cliente_website) if self.cliente_website is not None else '',
            'cliente_skype': self._serialize_enum_and_str(self.cliente_skype) if self.cliente_skype is not None else '',
            'cliente_facebook': self._serialize_enum_and_str(self.cliente_facebook) if self.cliente_facebook is not None else '',
            'atualizar_cliente': self._serialize_enum_and_str(self.atualizar_cliente) if self.atualizar_cliente is not None else '',
            'latitude_cli': self._serialize_enum_and_str(self.latitude_cli) if self.latitude_cli is not None else '',
            'longitude_cli': self._serialize_enum_and_str(self.longitude_cli) if self.longitude_cli is not None else '',
            'atualizar_login': self._serialize_enum_and_str(self.atualizar_login) if self.atualizar_login is not None else '',
            'latitude_login': self._serialize_enum_and_str(self.latitude_login) if self.latitude_login is not None else '',
            'longitude_login': self._serialize_enum_and_str(self.longitude_login) if self.longitude_login is not None else '',
        }
