...
class ServiceOrderModel(IModelWithId, BaseModel):
    ...
    setor: int
    id_atendente: str
    tipo: Mapped[Optional[TipoEnum]] = Field("tipo", Optional[TipoEnum], TipoEnum.CLIENTE)
    id_ticket: Mapped[Optional[int]] = Field("id_ticket", int, None)
    protocolo: Mapped[Optional[str]] = Field("protocolo", str, '')
    dica_assinatura_digital: Mapped[Optional[str]] = Field("dica_assinatura_digital", str, '')
    ...
    id_contrato_kit: Mapped[Optional[int]] = Field("id_contrato_kit", int, None)
    origem_endereco: Origem_enderecoEnum = Field("origem_endereco", Origem_enderecoEnum, Origem_enderecoEnum.MANUAL)
    origem_endereco_estrutura: Optional[Origem_endereco_estruturaEnum] = Field("origem_endereco_estrutura", Origem_endereco_estruturaEnum, Origem_endereco_estruturaEnum.ESTRUTURA)
    latitude: Mapped[Optional[str]] = Field("latitude", str, '')
    longitude: Mapped[Optional[str]] = Field("longitude", str, '')
    status_conexao: Mapped[Optional[Status_conexaoEnum]] = Field("status_conexao", Status_conexaoEnum, None)
    prioridade: PrioridadeEnum = Field("prioridade", PrioridadeEnum, PrioridadeEnum.NORMAL)
    melhor_horario_agenda: Optional[Melhor_horario_agendaEnum] = Field("melhor_horario_agenda", Melhor_horario_agendaEnum, Melhor_horario_agendaEnum.QUALQUER)
    id_tecnico: Mapped[Optional[int]] = Field("id_tecnico", int, None)
    mensagem: Mapped[Optional[str]] = Field("mensagem", str, '')
    id_receber: Mapped[Optional[str]] = Field("id_receber", str, '')
    idx: Mapped[Optional[str]] = Field("idx", str, '')
    status_pesquisa_satisfacao: Mapped[Optional[Status_pesquisa_satisfacaoEnum]] = Field("status_pesquisa_satisfacao", Status_pesquisa_satisfacaoEnum, None)
    status: StatusEnum = Field("status", StatusEnum, StatusEnum.ABERTA)
    habilita_assinatura_cliente: Mapped[Optional[str]] = Field("habilita_assinatura_cliente", str, '')
    status_assinatura: Optional[Status_assinaturaEnum] = Field("status_assinatura", Status_assinaturaEnum, Status_assinaturaEnum.PENDENTE)
    gera_comissao: Optional[Gera_comissaoEnum] = Field("gera_comissao", Gera_comissaoEnum, Gera_comissaoEnum.SIM)
    liberado: Optional[LiberadoEnum] = Field("liberado", LiberadoEnum, LiberadoEnum.SIM)
    impresso: Optional[ImpressoEnum] = Field("impresso", ImpressoEnum, ImpressoEnum.NAO)
    preview: Mapped[Optional[str]] = Field("preview", str, '')
    id_wfl_param_os: Mapped[Optional[str]] = Field("id_wfl_param_os", str, '')
    id_wfl_tarefa: Mapped[Optional[str]] = Field("id_wfl_tarefa", str, '')
    id_su_diagnostico: Mapped[Optional[int]] = Field("id_su_diagnostico", int, None)
    regiao_manutencao: Mapped[Optional[str]] = Field("regiao_manutencao", str, '')
    origem_cadastro: Optional[Origem_cadastroEnum] = Field("origem_cadastro", Origem_cadastroEnum, Origem_cadastroEnum.P)
    origem_change_endereco: Mapped[Optional[str]] = Field("origem_change_endereco", str, '')
    status_sla: Mapped[Optional[str]] = Field("status_sla", str, '')
    ultima_atualizacao: Mapped[Optional[str]] = Field("ultima_atualizacao", str, '')
    ids_login_regiao_manutencao: Mapped[Optional[str]] = Field("ids_login_regiao_manutencao", str, '')
    origem_os_aberta: Mapped[Optional[Origem_os_abertaEnum]] = Field("origem_os_aberta", Origem_os_abertaEnum, None)
    ...
    data_abertura: Mapped[Optional[str]] = Field("data_abertura", str, '')
    data_inicio: Mapped[Optional[str]] = Field("data_inicio", str, '')
    data_hora_analise: Mapped[Optional[str]] = Field("data_hora_analise", str, '')
    data_agenda: Mapped[Optional[str]] = Field("data_agenda", str, '')
    data_agenda_final: Mapped[Optional[str]] = Field("data_agenda_final", str, '')
    data_hora_encaminhado: Mapped[Optional[str]] = Field("data_hora_encaminhado", str, '')
    data_hora_assumido: Mapped[Optional[str]] = Field("data_hora_assumido", str, '')
    data_hora_execucao: Mapped[Optional[str]] = Field("data_hora_execucao", str, '')
    data_final: Mapped[Optional[str]] = Field("data_final", str, '')
    data_fechamento: Mapped[Optional[str]] = Field("data_fechamento", str, '')
    data_prazo_limite: Mapped[Optional[str]] = Field("data_prazo_limite", str, '')
    data_reservada: Mapped[Optional[str]] = Field("data_reservada", str, '')
    data_reagendar: Mapped[Optional[str]] = Field("data_reagendar", str, '')
    data_prev_final: Mapped[Optional[str]] = Field("data_prev_final", str, '')
    mensagem_resposta: Mapped[Optional[str]] = Field("mensagem_resposta", str, '')
    justificativa_sla_atrasado: Mapped[Optional[str]] = Field("justificativa_sla_atrasado", str, '')
    valor_total: Mapped[Optional[str]] = Field("valor_total", str, '')
    valor_outras_despesas: Mapped[Optional[str]] = Field("valor_outras_despesas", str, '')
    valor_unit_comissao: Mapped[Optional[str]] = Field("valor_unit_comissao", str, '')
    valor_total_comissao: Mapped[Optional[str]] = Field("valor_total_comissao", str, '')
